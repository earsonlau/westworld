...
#
# 开头空格都去掉
# 第一个非空字符如果是‘-’/‘+’，则记录下正负，sign=-1/1
# 最后就是处理边界问题，先处理边界再计算，这样可以避免越界，虽然python没有越界这个盖面
# 代码
#
...
#
# 作者：fabriceli
# 链接：https://leetcode-cn.com/problems/string-to-integer-atoi/solution/pythonqing-xi-yi-dong-de-zi-fu-chuan-zhuan-zheng-s/
# 来源：力扣（LeetCode）
